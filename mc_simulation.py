#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Stablecoins / Shadow Banking / Reserve Opacity Trap
===================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Stablecoins / Shadow Banking (Reserve Opacity Trap).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "stablecoins",
    "domain_name": "Stablecoins / Shadow Banking",
    "theorem": "Reserve Opacity Trap",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 56.0,
    "channels": {
        "C1_illicit_finance": {
            "dist": "lognormal",
            "low": 32.0,
            ...
            "high": 70.0,
            "weight": 0.35,
            "description": "Illicit stablecoin flows $141B (TRM Labs 2026), welfare multiplier 0.25-0.50. Sanctions evasion (Russia A7A5 $72-100B), ransomware, fraud, narcotics. Sources: TRM Labs, Chainalysis, UNODC."
        },
        "C2_systemic_contagion": {
            ...
            "high": 45.0,
            "weight": 0.2,
            "description": "Run risk and DeFi cascading liquidations. Tether $186B market cap, $7.8T annualized DeFi volume. USDC depeg precedent (March 2023, SVB). Sources: BIS, Fed Carapella et al. 2022, S&P."
        },
        "C3_shadow_banking_credit": {
            ...
            "high": 30.0,
            "weight": 0.15,
            "description": "DeFi leveraged lending without prudential supervision. Deposit flight from regulated banking ($1.5T potential, Brookings 2025). Procyclical credit expansion. Sources: Brookings, Fed, BIS."
        },
        "C4_regulatory_capture": {
            ...
            "high": 5.0,
            "weight": 0.03,
            "description": "Crypto industry $200M+ in political spending 2023-2024. Each lobbying dollar preserves ~$15 in extraction space. Delayed BSA enforcement, weakened GENIUS Act. Sources: OpenSecrets, FEC filings."
        },
        "C5_human_trafficking_scams": {
            ...
            "high": 17.0,
            "weight": 0.09,
            "description": "USDT as payment rail for pig-butchering scams ($10B+/yr), human trafficking operations. SE Asia compound scam centers. Sources: UNODC 2024, FBI IC3, Chainalysis."
        },
        "C6_governance_institutional": {
            ...
            "high": 35.0,
            "weight": 0.18,
            "description": "Sanctions architecture erosion, monetary sovereignty costs for developing nations, institutional trust degradation. Sources: OFAC, Treasury, IMF."
        }
    },
